      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex items-center justify-between border-b border-text/5 pb-2">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[9px] font-mono tracking-[0.2em] text-text uppercase font-bold">
              Simulation v1.4
            </span>
          </div>
        ...
        <div className="grid grid-cols-3 gap-2">
          <MouseHint
            icon={<MouseLeftClick01Icon size={24} strokeWidth={1} />}
            label=""
          />
          <MouseHint
            icon={<MouseRightClick01Icon size={24} strokeWidth={1} />}
            label="Pan"
          />
          <MouseHint
            icon={<MouseScroll01Icon size={24} strokeWidth={1} />}
            label="Zoom"
          />
        </div>
        ...
        <div className="flex flex-col gap-1.5">
          <span className="text-[8px] font-mono text-text/30 uppercase tracking-widest mb-1">
            Shortcuts
          </span>
            ...
            <KbdHint
              kbd={
                <div className="flex items-center gap-1">
                  Del / <Delete02Icon size={10} strokeWidth={2} />
                </div>
              }
              label="Delete"
            />
        ...
        <div className="pt-2 border-t border-text/5 flex items-center justify-between opacity-40">
          <span className="text-[7px] font-mono uppercase tracking-tighter text-text">
            Simulation
          </span>
        </div>
      </div>
...
const MouseHint = ({
  ...
  <div className="flex flex-col items-center gap-1">
    ...
    <span className="text-[8px] font-medium text-text/50 uppercase tracking-tighter">
      {label}
    </span>
  </div>
);
